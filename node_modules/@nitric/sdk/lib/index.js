...
var require_event_grpc_pb = __commonJS({
  "src/gen/proto/event/v1/event_grpc_pb.js"(exports) {
    "use strict";
    var grpc9 = require("@grpc/grpc-js");
    ...
    exports.EventServiceClient = grpc9.makeGenericClientConstructor(EventServiceService);
    ...
    exports.TopicServiceClient = grpc9.makeGenericClientConstructor(TopicServiceService);
  }
});
...
var require_document_grpc_pb = __commonJS({
  "src/gen/proto/document/v1/document_grpc_pb.js"(exports) {
    ...
    exports.DocumentServiceClient = grpc9.makeGenericClientConstructor(DocumentServiceService);
  }
});
...
var require_queue_grpc_pb = __commonJS({
  "src/gen/proto/queue/v1/queue_grpc_pb.js"(exports) {
    ...
    exports.QueueServiceClient = grpc9.makeGenericClientConstructor(QueueServiceService);
  }
});
...
var require_storage_grpc_pb = __commonJS({
  "src/gen/proto/storage/v1/storage_grpc_pb.js"(exports) {
    ...
    exports.StorageServiceClient = grpc9.makeGenericClientConstructor(StorageServiceService);
  }
});
...
var require_faas_grpc_pb = __commonJS({
  "src/gen/proto/faas/v1/faas_grpc_pb.js"(exports) {
    ...
    exports.FaasServiceClient = grpc9.makeGenericClientConstructor(FaasServiceService);
  }
});

// src/gen/proto/websocket/v1/websocket_pb.js
var require_websocket_pb = __commonJS({
  "src/gen/proto/websocket/v1/websocket_pb.js"(exports) {
    var jspb = require("google-protobuf");
    var goog = jspb;
    var global = function() {
      if (this) {
...
// src/gen/proto/websocket/v1/websocket_grpc_pb.js
var require_websocket_grpc_pb = __commonJS({
  "src/gen/proto/websocket/v1/websocket_grpc_pb.js"(exports) {
    "use strict";
    var grpc9 = require("@grpc/grpc-js");
    var proto_websocket_v1_websocket_pb = require_websocket_pb();
    var validate_validate_pb = require_validate_pb();
    ...
    exports.WebsocketServiceClient = grpc9.makeGenericClientConstructor(WebsocketServiceService);
  }
});
...
var require_resource_grpc_pb = __commonJS({
  "src/gen/proto/resource/v1/resource_grpc_pb.js"(exports) {
    ...
    exports.ResourceServiceClient = grpc9.makeGenericClientConstructor(ResourceServiceService);
  }
});
...
var require_secret_grpc_pb = __commonJS({
  "src/gen/proto/secret/v1/secret_grpc_pb.js"(exports) {
    ...
    exports.SecretServiceClient = grpc9.makeGenericClientConstructor(SecretServiceService);
  }
});
...
__export(src_exports, {
  ...
  WebsocketWorkerOptions: () => WebsocketWorkerOptions,
  api: () => api2,
  bucket: () => bucket2,
...
var WebsocketNotificationContext = class extends TriggerContext {
  get websocket() {
    return this;
  }
  static fromGrpcTriggerRequest(trigger) {
    const ctx = new WebsocketNotificationContext();
    const query = trigger.getWebsocket().getQueryParamsMap().getEntryList().reduce(
      (acc, [key, [val]]) => __spreadProps(__spreadValues({}, acc), {
  ...
  static toGrpcTriggerResponse(ctx) {
    ...
    const triggerResponse = new import_faas_pb.TriggerResponse();
    const notificationResponse = new import_faas_pb.WebsocketResponseContext();
    notificationResponse.setSuccess(notifyCtx.res.success);
...
var WebsocketNotificationRequest = class extends AbstractRequest {
  constructor(data, traceContext, socket, notificationType, connectionId, query) {
    super(data, traceContext);
    this.socket = socket;
...
var newTracerProvider = () => {
  ...
  const processor = localRun ? new import_sdk_trace_node.NoopSpanProcessor() : new import_sdk_trace_node.BatchSpanProcessor(
...
// src/api/websocket/v0/websocket.ts
var import_websocket_grpc_pb = __toESM(require_websocket_grpc_pb());
var import_websocket_pb = __toESM(require_websocket_pb());
var grpc4 = __toESM(require("@grpc/grpc-js"));
var Websocket = class {
  constructor() {
    this.client = new import_websocket_grpc_pb.WebsocketServiceClient(
      SERVICE_BIND,
  ...
  send(socket, connectionId, message) {
    return __async(this, null, function* () {
      ...
      const sendRequest = new import_websocket_pb.WebsocketSendRequest();
  ...
  close(socket, connectionId) {
    return __async(this, null, function* () {
      const closeRequest = new import_websocket_pb.WebsocketCloseRequest();
...
var WebsocketEventTypeMap = {
  connect: import_faas_pb2.WebsocketEvent.CONNECT,
  disconnect: import_faas_pb2.WebsocketEvent.DISCONNECT,
  message: import_faas_pb2.WebsocketEvent.MESSAGE
};
var WebsocketWorkerOptions = class {
  constructor(socket, eventType) {
    this.socket = socket;
    this.eventType = WebsocketEventTypeMap[eventType];
  }
};
var Websocket2 = class {
  constructor(socket, eventType, ...middleware) {
...
var WebsocketResource = class extends Resource2 {
  constructor(name) {
    super(name);
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setType(import_resource_pb2.ResourceType.WEBSOCKET);
      ...
      const defaultPrincipal = new import_resource_pb2.Resource();
      defaultPrincipal.setType(import_resource_pb2.ResourceType.FUNCTION);
      const policyResource = new import_resource_pb2.Resource();
      policyResource.setType(import_resource_pb2.ResourceType.POLICY);
      const policyReq = new import_resource_pb2.ResourceDeclareRequest();
      const policy = new import_resource_pb2.PolicyResource();
      policy.setActionsList([import_resource_pb2.Action.WEBSOCKETMANAGE]);
      policy.setPrincipalsList([defaultPrincipal]);
      policy.setResourcesList([resource]);
  ...
  on(eventType, ...middleware) {
    const notification2 = new Websocket2(this.name, eventType, ...middleware);
    return notification2["start"]();
  }
  resourceType() {
    return import_resource_pb2.ResourceType.WEBSOCKET;
  }
  unwrapDetails(resp) {
...
var Faas = class {
  ...
  start(...handlers) {
    return __async(this, null, function* () {
      ...
      if (!(this.options instanceof HttpWorkerOptions) && !this.httpHandler && !this.eventHandler && !this.bucketNotificationHandler && !this.websocketHandler && !this.anyHandler) {
      ...
      faasStream.on("data", (message) => __async(this, null, function* () {
        if (message.hasInitResponse()) {
          ...
          const responseMessage = new import_faas_pb3.ClientMessage();
          ...
          try {
            ...
            console.error(e);
            const triggerResponse = new import_faas_pb3.TriggerResponse();
            ...
            if (triggerRequest.hasHttp()) {
              const httpResponse = new import_faas_pb3.HttpResponseContext();
              ...
              const contentTypeHeader = new import_faas_pb3.HeaderValue();
              contentTypeHeader.addValue("text/plain");
              headers.set("Content-Type", contentTypeHeader);
            } else if (triggerRequest.hasTopic()) {
              const topicResponse = new import_faas_pb3.TopicResponseContext();
              topicResponse.setSuccess(false);
              triggerResponse.setTopic(topicResponse);
            } else if (triggerRequest.hasNotification()) {
              const notificationResponse = new import_faas_pb3.NotificationResponseContext();
              notificationResponse.setSuccess(false);
              triggerResponse.setNotification(notificationResponse);
            } else if (triggerRequest.hasWebsocket()) {
              const notificationResponse = new import_faas_pb3.WebsocketResponseContext();
              notificationResponse.setSuccess(false);
              triggerResponse.setWebsocket(notificationResponse);
            }
          }
      ...
      const initRequest = new import_faas_pb3.InitRequest();
      const initMessage = new import_faas_pb3.ClientMessage();
      if (this.options instanceof ApiWorkerOptions2) {
        const apiWorker = new import_faas_pb3.ApiWorker();
        apiWorker.setApi(this.options.api);
        apiWorker.setMethodsList(this.options.methods);
        apiWorker.setPath(this.options.route);
        const opts = new import_faas_pb3.ApiWorkerOptions();
        if (this.options.opts && this.options.opts.security) {
          if (Object.keys(this.options.opts.security).length == 0) {
            ...
            Object.keys(methodOpts.security).forEach((k) => {
              const scopes = new import_faas_pb3.ApiWorkerScopes();
        ...
        const scheduleWorker = new import_faas_pb3.ScheduleWorker();
        scheduleWorker.setKey(this.options.description);
        const rate = new import_faas_pb3.ScheduleRate();
        ...
        const notificationWorker = new import_faas_pb3.BucketNotificationWorker();
        notificationWorker.setBucket(this.options.bucket);
        const config = new import_faas_pb3.BucketNotificationConfig();
        ...
        const httpWorker = new import_faas_pb3.HttpWorker();
        ...
        const websocketWorker = new import_faas_pb3.WebsocketWorker();
...
var Api = class extends Resource2 {
  ...
  resourceType() {
    return import_resource_pb3.ResourceType.API;
  }
  unwrapDetails(resp) {
    if (resp.hasApi()) {
      return {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      const apiResource = new import_resource_pb3.ApiResource();
      const { security, securityDefinitions } = this;
      if (security) {
        Object.keys(security).forEach((k) => {
          const scopes = new import_resource_pb3.ApiScopes();
          scopes.setScopesList(security[k]);
          apiResource.getSecurityMap().set(k, scopes);
        });
      }
      resource.setName(this.name);
      resource.setType(import_resource_pb3.ResourceType.API);
      if (securityDefinitions) {
        Object.keys(securityDefinitions).forEach((k) => {
          const def = securityDefinitions[k];
          const definition = new import_resource_pb3.ApiSecurityDefinition();
          if (def.kind === "jwt") {
            const secDef = new import_resource_pb3.ApiSecurityDefinitionJwt();
...
var TopicResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resource_pb4.ResourceType.TOPIC);
      req.setResource(resource);
      return new Promise((resolve, reject) => {
    ...
    return perms.reduce((actions, p) => {
      switch (p) {
        case "publishing":
          return [
            ...actions,
            import_resource_pb4.Action.TOPICEVENTPUBLISH,
            import_resource_pb4.Action.TOPICLIST,
            import_resource_pb4.Action.TOPICDETAIL
          ];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resource_pb4.ResourceType.TOPIC;
  }
  /**
...
var QueueResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resource_pb5.ResourceType.QUEUE);
      req.setResource(resource);
      return new Promise((resolve, reject) => {
        client_default.declare(req, (error) => {
          if (error) {
  ...
  permsToActions(...perms) {
    let actions = perms.reduce((actions2, p) => {
      switch (p) {
        case "sending":
          return [...actions2, import_resource_pb5.Action.QUEUESEND];
        case "receiving":
          return [...actions2, import_resource_pb5.Action.QUEUERECEIVE];
        default:
          throw new Error(
            `unknown permission ${p}, supported permissions is publishing.}
            )}`
    ...
    if (actions.length > 0) {
      actions = [...actions, import_resource_pb5.Action.QUEUELIST, import_resource_pb5.Action.QUEUEDETAIL];
    }
    return actions;
  }
  resourceType() {
    return import_resource_pb5.ResourceType.QUEUE;
  }
  unwrapDetails(resp) {
...
var CollectionResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resource_pb6.ResourceType.COLLECTION);
      req.setResource(resource);
      return new Promise((resolve, reject) => {
        client_default.declare(
          req,
  ...
  permsToActions(...perms) {
    let actions = perms.reduce((actions2, perm) => {
      switch (perm) {
        case "reading":
          return [
            ...actions2,
            import_resource_pb6.Action.COLLECTIONDOCUMENTREAD,
            import_resource_pb6.Action.COLLECTIONQUERY
          ];
        case "writing":
          return [...actions2, import_resource_pb6.Action.COLLECTIONDOCUMENTWRITE];
        case "deleting":
          return [...actions2, import_resource_pb6.Action.COLLECTIONDOCUMENTDELETE];
        default:
          throw new Error(
    ...
    if (actions.length > 0) {
      actions = [...actions, import_resource_pb6.Action.COLLECTIONLIST];
    }
    return actions;
  }
  resourceType() {
    return import_resource_pb6.ResourceType.COLLECTION;
  }
  unwrapDetails(resp) {
...
var import_faas_pb4 = __toESM(require_faas_pb());
...
var BucketNotificationWorkerOptions2 = class {
  ...
  static toGrpcEvent(notificationType) {
    switch (notificationType) {
      case "write":
        return import_faas_pb4.BucketNotificationType.CREATED;
      case "delete":
        return import_faas_pb4.BucketNotificationType.DELETED;
      default:
...
var BucketResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resource_pb7.ResourceType.BUCKET);
      req.setResource(resource);
      return new Promise((resolve, reject) => {
        client_default.declare(req, (error, _) => {
          if (error) {
  ...
  permsToActions(...perms) {
    return perms.reduce((actions, perm) => {
      switch (perm) {
        case "reading":
          return [...actions, import_resource_pb7.Action.BUCKETFILEGET, import_resource_pb7.Action.BUCKETFILELIST];
        case "writing":
          return [...actions, import_resource_pb7.Action.BUCKETFILEPUT];
        case "deleting":
          return [...actions, import_resource_pb7.Action.BUCKETFILEDELETE];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resource_pb7.ResourceType.BUCKET;
  }
  unwrapDetails(resp) {
...
var import_resource_pb8 = __toESM(require_resource_pb());
...
var SecretResource = class extends SecureResource {
  register() {
    return __async(this, null, function* () {
      const req = new import_resource_pb8.ResourceDeclareRequest();
      const resource = new import_resource_pb8.Resource();
      resource.setName(this.name);
      resource.setType(import_resource_pb8.ResourceType.SECRET);
      req.setResource(resource);
      return new Promise((resolve, reject) => {
        client_default.declare(
          req,
  ...
  permsToActions(...perms) {
    return perms.reduce((actions, perm) => {
      switch (perm) {
        case "put":
          return [...actions, import_resource_pb8.Action.SECRETPUT];
        case "access":
          return [...actions, import_resource_pb8.Action.SECRETACCESS];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resource_pb8.ResourceType.SECRET;
  }
  unwrapDetails(resp) {
