...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={mergeClass(
      'fixed bottom-0 z-[100] flex max-h-screen laptop:w-3/12 justify-end flex-col-reverse gap-3 p-4 right-0 top-auto',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={mergeClass(
      'absolute right-2 top-2 rounded-md p-1 text-neutral-600 dark:text-neutral-300 opacity-0 transition-opacity hover:text-black focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 hover:bg-neutral-100 dark:hover:bg-neutral-800',
      className,
    )}
    toast-close=""
    {...props}
